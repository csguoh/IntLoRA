export MODEL_NAME="/data/guohang/pretrained/stable-diffusion-v1-5"
...
do
  ...
  export OUTPUT_DIR="log_quant/${name}"
  export INSTANCE_DIR="/data/guohang/dataset/dreambooth/${selected_subject}"
  export CLASS_DIR="/data/guohang/ControlNet/oft-db/data/class_data/${class_token}"



  python train_dreambooth_quant.py \
    ...
    #--gradient_checkpointing #one can uncomment the GC to reduce the GPU memory
done
